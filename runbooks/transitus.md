...
Short, human-language instructions for when Watchtower flags Transitus.
No jargon. No code walls. Glance, act, breathe.

---

## At a glance
- **Name / slug**: Transitus / `transitus`
- **Live URL**: https://jeromydarling.github.io/transitus/
- **Repo**: https://github.com/jeromydarling/transitus-be0eceba
- **Tier**: Tier 2
- **Dashboard tile**: https://jeromydarling.github.io/watchtower/#transitus
...
- **Lovable app URL**: https://jeromydarling.github.io/transitus/
