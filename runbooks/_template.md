...
Short, human-language instructions for when Watchtower flags {PROJECT_NAME}.
No jargon. No code walls. Glance, act, breathe.

---

## At a glance
- **Name / slug**: {PROJECT_NAME} / `{SLUG}`
- **Live URL**: {HEALTH_URL}
- **Repo**: https://github.com/{REPO}
- **Tier**: {TIER}
- **Dashboard tile**: https://jeromydarling.github.io/watchtower/#{SLUG}
