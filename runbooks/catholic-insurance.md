# Catholic Insurance runbook

Short, human-language instructions for when Watchtower flags Catholic Insurance.
No jargon. No code walls. Glance, act, breathe.

---

## At a glance
- **Name / slug**: Catholic Insurance / `catholic-insurance`
- **Live URL**: (not set yet)
- **Repo**: https://github.com/jeromydarling/catholic-insurance
- **Tier**: Tier 2
- **Dashboard tile**: https://jeromydarling.github.io/watchtower/#catholic-insurance
