# Heritage Kitchen runbook

Short, human-language instructions for when Watchtower flags Heritage Kitchen.
No jargon. No code walls. Glance, act, breathe.

---

## At a glance
- **Name / slug**: Heritage Kitchen / `heritage-kitchen`
- **Live URL**: https://heritage-kitchen-app.lovable.app
- **Repo**: https://github.com/jeromydarling/heritage-kitchen
- **Tier**: Tier 2
- **Dashboard tile**: https://jeromydarling.github.io/watchtower/#heritage-kitchen
...
- **Lovable app URL**: https://heritage-kitchen-app.lovable.app
