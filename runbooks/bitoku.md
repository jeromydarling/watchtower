...
Short, human-language instructions for when Watchtower flags Bitoku.
No jargon. No code walls. Glance, act, breathe.

---

## At a glance
- **Name / slug**: Bitoku / `bitoku`
- **Live URL**: https://bitoku.lovable.app
- **Repo**: https://github.com/jeromydarling/bitoku
- **Tier**: Tier 2
- **Dashboard tile**: https://jeromydarling.github.io/watchtower/#bitoku
...
- **Lovable app URL**: https://bitoku.lovable.app
